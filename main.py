...
def click(event):
    ...
    try:
        if txt== "=":
            ...
            if content_var.get().isdigit() and content_var.get()!="":
            ...
            if content_var.get().isdigit() and content_var.get()!="":
                value = math.radians(float(content_var.get()))  # Type casting the value to float to get its vale in radians
                content_var.set(math.sin(value))   # calculating the sine of the value (in radians)
            else:
                tmsg.showinfo("NOTE", "Evaluate the Expression First!")
            ...
            if content_var.get().isdigit() and content_var.get()!="":    
                ...
                content_var.set(math.cos(value))  # Value of the cosine of the value (in radians)
            else:
                tmsg.showinfo("NOTE", "Evaluate the Expression First!")
        else:
...
button_sin = Button(main_frame_5, text="Sin", font="comicsansms 30 bold", padx=18, pady=23, fg="#5f3ea6", highlightbackground="grey")
...
button_cos = Button(main_frame_6, text="Cos", font="comicsansms 27 bold", padx=18, pady=23, fg="#5f3ea6", highlightbackground="grey")
